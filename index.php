        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>The most powerful farm management software</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="register">Get Started!</a>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="light my-4">
            <p class="text-faded mb-4">Farming Assistant lets you plan, monitor and analyze all activities on your farm easily. Tillage, planting, spraying, fertilization, irrigation, harvesting and all other activities are managed with a few clicks</p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto text-center">
            ...
            <p>
              <a href="mailto:info@farmingassistant.tk">info@farmingassistant.tk</a>
            </p>
          </div>
        </div>
      </div>
